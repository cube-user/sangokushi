...
public class RyohuSenko {
	...
	public void ikusa(Ryohu ryohu, Chokaku chokaku) {
		...
		//呂布のターン
		System.out.println("★★★速度の影響により" + ryohu.name + "が先攻★★★");
		//呂布の固有戦法発動の抽選
		...
		System.out.println(ryohu.activeSenpo1Name + "の発動率は" + ryohu.aSenpo1Hatsudoritsu + "%");
		...
		//張角のターン
		System.out.println("★★★速度の影響により" + chokaku.name + "が後攻★★★");
